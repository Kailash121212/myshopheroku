...
export default function Cpanal_Update_Maincategory() {
        ...
        <>
            <div className='row mt-5'>
                ...
                <div className='col-xxl-10 col-xl-10 col-lg-9 col-md-8 col-sm-6 col-12'>
                    <h5 className='background text-light text-center p-2'>Maincategory</h5>
                    <form>
                        <div className="mb-3">
                            <label  className="form-label">Name</label>
                            <input type="text" onChange={getData} className="form-control" id="name" placeholder='enter maincategory name' value={name} />
                        </div>
