                    ...
                    <div className='col-xxl-10 col-xl-10 col-lg-9 col-md-8 col-sm-6 col-12'>
                        ...
                        <form>
                            <div className="mb-3">
                                ...
                                <input type="text" onChange={getData} className="form-control" name="name" placeholder='Enter Main Category Name' />
                            </div>
                            ...
                            <div className='row mb-3'>
                                <div className='col-sm-6 col-12'>
                                    ...
                                    <input type="number" onChange={getData} className="form-control" name="baseprice" placeholder='Enter Base Price of Product' />
                                </div>
                                <div className='col-sm-6 col-12'>
                                    <label className="form-label">Discount</label>
                                    <input type="number" onChange={getData} className="form-control" name="discount" min="0" max="100" placeholder='Enter Discount Of Product' />
                                </div>
                            </div>
                            <div className='row mb-3'>
                                <div className='col-sm-6 col-12'>
                                    <label className="form-label">Color</label>
                                    <input type="text" onChange={getData} className="form-control" name="color" placeholder='Enter Color of Product' />
                                </div>
                                <div className='col-sm-6 col-12'>
                                    <label className="form-label">Size</label>
                                    <input type="text" onChange={getData} className="form-control" name="size"  placeholder='Enter Size of Product' />
                                </div>
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Description</label>
                                <textarea name='description' onChange={getData} className='form-control' defaultValue="This is Sample product"></textarea>
                            </div>
                            <div className='row mb-3'>
                                <div className='col-sm-6 col-12'>
                            ...
                            <button type="submit" onClick={postData} className="btn background text-light w-100">Add</button>
                        </form>
                    </div>
                </div>
        </>
